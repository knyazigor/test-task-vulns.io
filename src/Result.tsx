...
const Result: FC<ResultProps> = ({ data, loading, error }) => {
  ...
  return (
    <div className={styles.result}>
      <PanelBar>
        <PanelBarItem title="Статус аудита" expanded={true}>
          <div className={styles.auditBar}>
            <div className={styles.auditStateBarRecord}>
              <strong>Статус:</strong>
              {data.isVulnerable ? "Уязвимый" : "Безопасный"}
            </div>
            <div className={styles.auditStateBarRecord}>
        ...
        <PanelBarItem title="Уязвимые пакеты" expanded={true}>
          <div className={styles.auditBar}>
            {data.vulnerableObjects.length === 0 ? (
              ...
              <div style={{ maxHeight: "300px", overflow: "auto" }}>
                ...
                >
                  <GridColumn field="name" title="Имя пакета" width="200px" />
                  <GridColumn field="version" title="Версия" width="120px" />
                  <GridColumn field="arch" title="Архитектура" width="120px" />
                  <GridColumn
                    field="vulns.length"
                    title="Уязвимости"
                    width="100px"
        ...
        <PanelBarItem title="Подробности (JSON)" expanded={false}>
